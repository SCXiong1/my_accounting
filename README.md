...
- 时间筛选 — 记账记录页支持本月/近3月/近6月/今年/自定义时间范围
...
e2e/
  tests/              # 12 个 E2E 测试：S1 认证、S2 记账 CRUD、S3 表单交互、S4 统计、S5 下拉刷新、S6 分类管理、S7 标签管理、S8 导航稳定性、S9 记账表单优化、S10 分类标签联动、S11 记账列表筛选、S12 回收站批量删除
```
